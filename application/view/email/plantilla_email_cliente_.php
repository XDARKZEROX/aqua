                ...
                <tr>
                    <td bgcolor="#DEE6BD" class="header" style="padding: 40px 30px 20px 30px;">
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="70">
                            <tr>
                                <td height="0" style="padding: 0 20px 20px 0;"><img alt="" border="0" class="fix" height="70" src="http://aquaph9.com/emailing/images/mensaje_icono.jpg" style="height: auto;" width="<70></70>" /></td>
                            </tr>
                        </table>
                        <!--[if (gte mso 9)|(IE)]>
                ...
                <tr>
                    <td class="innerpadding borderbottom" style="border-bottom: 1px solid #f2eeed; padding: 30px 10px 30px 10px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td class="bodycopy" style="color: #153643; font-family: sans-serif; font-size: 16px; line-height: 22px;"> Tu pedido está a la espera hasta que confirmemos que el pago se ha recibido. <br /> Los detalles de tu pedido se muestran debajo como referencia: <br />
                                    <br /> Para agilizar el pago por transferencia bancaria necesitaremos que realices un ingreso indicando en el concepto el número de pedido, IMPRESCINDIBLE para agilizar el envio del pedido. </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td class="bodycopy" style="color: #153643; font-family: sans-serif; font-size: 16px; line-height: 22px;"><strong>Pedido registrado:</strong> <?=$rowQueryFacturaResult['dFechaCompra'];?> <br />
                                    ...
                                    ?>
                                    <? if($rowQueryFacturaResult['vTipoTarjeta']!='2'){ ?>
                                    <br /><strong>Nuestros detalles bancarios:</strong><br /> Alkaline Water S.L. - La Caixa <br /> ES37 2100 4864 4122 0004 9449 <br />
                                    <? } ?>
                                    <br /><strong>N° de pedido: </strong>#<?=$rowQueryFacturaResult['vNumeroPedido'];?><br /><strong>N° de factura: </strong><?=$rowQueryFacturaResult['iIdFactura'];?><br />
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="center" class="footercopy" style="font-family: sans-serif;font-size: 14px;color: #ffffff;">
                                    ...
                                    Dirección: ALKALINE WATER S.L. <br>
                                    B66443797 <br>
                                    C/ PENEDES, 49 <br>
