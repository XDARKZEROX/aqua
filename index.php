...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="carousel-inner">
        ...
        <!--                        <div class="item">                          <img src="public/images/slider/3.png" alt="">                          <div class="container">                            <div class="carousel-caption">                              <h1></h1>                              <p class="lead"></p>                            </div>                          </div>                        </div>            -->
    </div>
</div>
...
<section class="bloque_color verde right">
    <div class="container">
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 imagen">                <img class="col-xs-7 col-sm-11 col-md-11 col-lg-11" src="public/images/familia-feliz.png">            </div>
...
<section class="bloque_color celeste left">
    <div class="container ">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 imagen">                <img class="col-xs-7 col-sm-11 col-md-11 col-lg-11" src="public/images/agua-alcalina.png">            </div>
    </div>
</section>
<section class="bloque_color naranja right">
    <div class="container">
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 imagen">                <img class="col-xs-7 col-sm-11 col-md-11 col-lg-11" src="public/images/deportistas-agua.png">            </div>
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 texto">
            <div class="col-xs-12 col-sm-11 col-md-11 col-lg-11  container_text">
