...
<div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="widget animated fadeInUp">
                <div class="widget-head">
                    <div class="pull-left"><i class="fa fa-edit"></i> Informacion General</div>
                    <div class="clearfix"></div>
                </div>
                <div class="widget-content padd">
                    <div class="form-group">
                        <label><i class="fa fa-info-circle"></i> Nombre</label>
                        <?php echo Form::input('name', Input::post('name', isset($model) ? $model->name : ''), array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Nombre de Tienda')); ?>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-globe"></i> Pagina Web</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-phone-square"></i> Telefono</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary submit-btn"><i class="fa fa-save"></i> Guardar
                            </button>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget animated fadeInUp">
                <div class="widget-head">
                    <div class="pull-left"><i class="fa fa-edit"></i> Categorias & Servicios</div>
                    <div class="clearfix"></div>
                </div>
                <div class="widget-content padd">
                    <div class="form-group">
                        <label><i class="fa fa-tags"></i> Categorias</label>
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-tags"></i> Servicios</label>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget animated fadeInUp">
                <div class="widget-head">
                    <div class="pull-left"><i class="fa fa-edit"></i> Redes Sociales</div>
                    <div class="clearfix"></div>
                </div>
                <div class="widget-content padd">
                    <div class="row">
...
<div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget animated fadeInUp">
                <div class="widget-head">
                    <div class="pull-left"><i class="fa fa-edit"></i> Localizacion</div>
                    <div class="clearfix"></div>
                </div>
                <div class="widget-content padd">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Ciudad/Provincia (Admin Area Level 2)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Estado/Region (Admin Area Level 1)</label>
                    ...
                    <div style="text-align: right">
                        <i class="fa fa-leaf"></i> Deja valores de latitud / longitud en blanco a buscar (codificación geográfica) en enviar.
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget animated fadeInUp">
                <div class="widget-head">
                    <div class="pull-left"><i class="fa fa-edit"></i> Horas & Imagen Subir</div>
                    <div class="clearfix"></div>
                </div>
                <div class="widget-content padd">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-picture-o"></i> Subir Imagen</label>
