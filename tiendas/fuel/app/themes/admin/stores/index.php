<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="widget animated fadeInUp">
            <div class="widget-head">
                <div class="pull-left"><i class="fa fa-<?php echo $icon; ?>"></i> Tiendas de importacion de CSV </div>
            ...
            <div class="widget-foot">
                <div class="row">
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-upload"></i> Subir & Import CSV</button>
                    </div>
                    <div class="col-md-6">
                        <a type="button" class="btn btn-primary" href="<?php echo Uri::create('assets/sample.csv'); ?>"><i class="fa fa-download"></i> CSV Muestra</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-9">
        <div class="widget animated fadeInUp">
            ...
            <div class="widget-content padd">
                Usted puede gestionar y crear búsqueda de nuevas tiendas. Haga clic en <a href="<?php echo Uri::create('admin/stores/create'); ?>">Añadir Tienda</a> para crear una nueva
                localizacion o <a href="#">import</a> para subir una CSV hoja de cálculo de posiciones.
            </div>
            <div class="widget-foot">
...
<div class="row">
    <div class="col-md-12">
        <div class="widget animated fadeInUp">
            <div class="widget-head">
                <div class="pull-left"><i class="fa fa-th-list"></i> Tiendas Localizadas</div>
                <div class="widget-icons pull-right">
                    <a class="wminimize" href="#"><i class="fa fa-chevron-up"></i></a>
                    <a class="wclose" href="#"><i class="fa fa-times"></i></a>
                </div>
            ...
            <div class="widget-content">
                ...
                <table class="data-table table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th><a href="#" name="name">Nombre</a></th>
                        <th class="hidden-xs"><a href="#" name="address">Direccion</a></th>
                        <th class="visible-lg"><a href="#" name="administrative_area_level_2">Ciudad</a></th>
                        <th class="visible-lg"><a href="#" name="administrative_area_level_1">Estado/Provincia</a></th>
                        <th class="hidden-sm hidden-xs"><a href="#" name='postal_code'>Codigo Postal</a></th>
                        <th class="hidden-sm hidden-xs"><a href="#" name='country'>Pais</a></th>
                        <th class="visible-lg"><a href="#" name="status">Ver</a></th>
                        <th>&nbsp;</th>
                    </tr>
                    <tr>
                    ...
                    <?php if (!$items): ?>
                        <tr>
                            <td colspan="8" class="padd">Tiendas No Localizadas.</td>
                        </tr><?php else: ?>
                        <tbody>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><a href="<?php echo Uri::create('admin/stores/edit/' . $model->id); ?>"
                                                   class=""><i class="fa fa-edit"></i> Editar</a></li>
                                            <li>
                                                <a href="<?php echo Uri::create('admin/stores/delete/' . $model->id); ?>"
                                                   class="del-btn"><i class="fa fa-trash-o"></i> Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="row">
                    ...
                    <div class='col-md-6'>
                        <div class="pull-right" style='font-size:120%;margin:0px 10px 0px 0px;'>
                            Tiendas <?php echo number_format($total); ?> resultados (<?php echo $time; ?> segundos)
                        </div>
                    </div>
                </div>
            </div>
