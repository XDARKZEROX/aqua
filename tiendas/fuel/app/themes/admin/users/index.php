    ...
    <div class="col-md-12">
        <div class="widget animated fadeInUp">
            ...
            <div class="widget-content padd">
                Usted puede gestionar y crear usuarios de búsqueda de abajo. Haga clic en <a href="#">crear usuario</a> para crear una nueva cuenta de usuario.
            </div>
            <div class="widget-foot">
                <a type="button" class="btn btn-primary" href="<?php echo Uri::create('admin/users/create'); ?>"><i
                        class="fa fa-plus-square"></i> Crear Usuario</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="widget animated fadeInUp">
            <div class="widget-head">
                <div class="pull-left"><i class="fa fa-th-list"></i> Usuarios</div>
                <div class="widget-icons pull-right">
                    <a class="wminimize" href="#"><i class="fa fa-chevron-up"></i></a>
                    <a class="wclose" href="#"><i class="fa fa-times"></i></a>
                </div>
            ...
            <div class="widget-content">
                ...
                <table class="data-table table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th><a href="#" name="first_name">Nombre</a></th>
                        <th><a href="#" name="last_name">Apellido</a></th>
                        <th class="hidden-xs"><a href="#" name="email">Email</a></th>
                        <th class="visible-lg"><a href="#" name="last_login">Ultimo inicio de sesion</a></th>
                        <th>&nbsp;</th>
                    </tr>
                    <tr>
