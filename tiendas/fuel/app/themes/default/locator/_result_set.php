<div class="result-options" style="padding:5px 10px; display: none; overflow: auto;">
    <div class="btn-group">
        ...
        <?php endif; ?>
        <div class="pull-right text-muted btn-sm"><span class="total_items"></span> results in <span
...
<div class="list-group loc-result-set " style="margin-bottom:0px; max-height: 480px; overflow: auto;">
    <div class="highlight list-group-item default-item" style="margin-bottom:0px;">
        <p class="list-group-item-text">
            <strong>Por favor introduzca una ubicacion</strong>

        <div>Le mostraremos la tienda mas cercana.</div>
        </p>
    </div>
    <div class="highlight list-group-item no-results-item hide" style="margin-bottom:0px;">
        <p class="list-group-item-text">
            <strong><i class="fa fa-info-circle"></i>Lo sentimos, no hay resultados.</strong>

        <div>Por favor, intente otra ubicacion y / o los filtros.</div>
        </p>
    </div>
        ...
        <div class="list-group-item-text">
            ...
            <div style="overflow:auto;">
                ...
                <div style="margin-top:5px; font-size:90%;">
                    <a class="btn-detail"><i class="fa fa-map-marker"></i> Direccion y Horarios</a><br>
                    <div>
...
<div class="list-group loc-store-detail-template hide"
    ...
    <div class="highlight list-group-item" style="margin-bottom: 0px; ">
        ...
        <h5 style="margin:0px;line-height: 30px;">Detalle de Localizacion</h5>
    </div>
                ...
                <div style="margin-top:5px;" class="btn-group">
                    ...
                    <ul class="dropdown-menu direction-links" role="menu">
                        <li><a href="https://maps.google.com/maps?daddr=" target="_blank"><i
                                    class="fa fa-external-link"></i> Direcciones en Google Maps</a></li>
                        <li><a href="http://www.bing.com/maps/default.aspx?rtp=adr~adr." target="_blank"><i
                                    class="fa fa-external-link"></i> Direccion Bing Maps </a></li>
                        <!-- <li><a href="http://mapq.st/directions?q=" target="_blank"><i class="fa fa-external-link"></i> Direccion MapQuest </a></li> -->
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="list-group-item template-item" style="cursor: pointer">
        <div class="list-group-item-text" style="min-height: 50px;">
            ...
            <div style="font-weight: bold;">Servicios</div>
            <div>
                <div>
    ...
    <div class="list-group-item template-item" style="">
        <div class="list-group-item-text" style="min-height: 50px;">
            <div style="font-weight: bold;">Informacion adicional"</div>
            <div>
                <div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Resultado filtro de busqueda</h4>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <?php if(count($categories)): ?>
                                        <strong>Categoria de filtros:</strong>
                                        <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <?php if(count($services)): ?>
                                        <strong>Filtro de servicios:</strong>
                                        <div class="row">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-default" ><i class="fa fa-search"></i> Aplicar busqueda de filtros</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
    </form>
