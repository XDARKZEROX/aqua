...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "18");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "5.1.0");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "postcomment_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjLog', 'pjInstaller', 'pjBackup', 'pjSms', 'pjOneAdmin');
?>