...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTopics&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminTopics' ? 'menu-focus' : NULL; ?>"><span class="menu-topics">&nbsp;</span><?php __('menuTopics'); ?></a></li>
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminComments&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminComments' ? 'menu-focus' : NULL; ?>"><span class="menu-comments">&nbsp;</span><?php __('menuComments'); ?></a></li>
