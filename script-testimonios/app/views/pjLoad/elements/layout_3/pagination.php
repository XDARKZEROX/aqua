<div class="pc-paging-container">
	...
	if (isset($tpl['paginator']))
	{
		...
		<ul class="pc-paginator">
			...
			if ($page > 1)
			{
				?><li><a class="page-link link-previous" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $page - 1; ?>" ></a></li><?php
			}else{
				?><li><a class="page-link link-previous" href="javascript:void(0);" ></a></li><?php
			}
			...
			if ($page < $counter - 1){
				 ?><li><a class="page-link link-next" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $page + 1; ?>" ></a></li><?php
			}else{
				?><li><a class="page-link link-next" href="javascript:void(0);" ></a></li><?php
			}
			?>
