<div class="pc-paging-container">
	...
	{		
		...
		<ul class="pc-paginator">
			...
			if ($page > 1)
			{
				?><li><a class="page-link link-previous" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $page - 1; ?>" ><?php __('front_paging_previous');?></a></li><?php
			}else{
				?><li><a class="page-link link-previous" href="javascript:void(0);" ><?php __('front_paging_previous');?></a></li><?php
			}
			if ($lastpage < 7 + ($stages * 2))
			{
				...
				if($page < 1 + ($stages * 2))		
				{
					...
					{
						if ($counter == $page){
							?><li><a href="javascript:void(0);" class="page-node current"><?php echo $counter; ?></a></li><?php
						}else{
							?><li><a class="page-node" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $counter; ?>" ><span><?php echo $counter; ?></span></a></li><?php
						}	
					}
					...
					for ($counter = $page - $stages; $counter <= $page + $stages; $counter++){
						if ($counter == $page)
						{
							...
							?><li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $counter; ?>" ><span><?php echo $counter; ?></span></a></li><?php
						}
					}
					?>
					<li class="dot">.</li>
			...
			if ($page < $counter - 1){
				 ?><li><a class="page-link link-next" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php echo $query_string;?>&amp;pjPage=<?php echo $page + 1; ?>" ><?php __('front_paging_next');?></a></li><?php
			}else{
				?><li><a class="page-link link-next" href="javascript:void(0);" ><?php __('front_paging_next');?></a></li><?php
			}
			?>
		</ul>
		<?php
