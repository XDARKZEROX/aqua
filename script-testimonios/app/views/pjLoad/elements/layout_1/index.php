<div class="pc-container">
	...
	<?php include_once PJ_VIEWS_PATH . 'pjLoad/elements/layout_1/comment_list.php';?>
	<div class="pc-form-container">
		<div class="pc-heading">
			...
			<div class="pc-menu">
				...
				{ 
					?>
					<a class="pc-menu-item" href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?controller=pjLoad&amp;action=pjActionLogout<?php echo isset($_GET['iframe']) ? '&amp;iframe' : NULL; ?>"><?php __('front_menu_logout');?></a><abbr>&nbsp;&nbsp;|&nbsp;&nbsp;</abbr>
					<a class="pc-menu-item" href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?controller=pjLoad&amp;action=pjActionMyProfile<?php echo isset($_GET['iframe']) ? '&amp;iframe' : NULL; ?>"><?php __('front_menu_my_profile');?></a>
					<?php
				}else{
					?>
					<a class="pc-menu-item" href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?controller=pjLoad&amp;action=pjActionLogin<?php echo isset($_GET['iframe']) ? '&amp;iframe' : NULL; ?>"><?php __('front_menu_login');?></a><abbr>&nbsp;&nbsp;|&nbsp;&nbsp;</abbr>
					<a class="pc-menu-item" href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?controller=pjLoad&amp;action=pjActionRegister<?php echo isset($_GET['iframe']) ? '&amp;iframe' : NULL; ?>"><?php __('front_menu_register');?></a>
					<?php
				} 
				?>
			</div>
