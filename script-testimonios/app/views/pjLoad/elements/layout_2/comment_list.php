<div class="pc-comment-list">
	...
	if(!empty($tpl['comment_arr']))
	{
			...
			<div class="pc-comment-box">
				<div class="heading">
					...
					<div class="comment-detail">
						<label><?php echo stripslashes($v['member']); ?>&nbsp;&nbsp;<span><?php echo pjUtil::formatDate(date('Y-m-d', strtotime($v['created'])), "Y-m-d", $tpl['option_arr']['o_date_format']) . ' ' . date($tpl['option_arr']['o_time_format'], strtotime($v['created'])); ?></span></label>
						<?php
		...
		include_once PJ_VIEWS_PATH . 'pjLoad/elements/layout_2/pagination.php';
	} else {
