	...
	<div class="pc-form-container">
		<div class="pc-heading">
			<div class="pc-title">
				...
				<span class="title-text"><?php __('front_label_leave_comment');?></span>
		...
		<form name="frmPostComment" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>?controller=pjLoad&amp;action=pjActionIndex<?php echo isset($_GET['iframe']) ? '&amp;iframe' : NULL; ?>" method="post" class="pc-form"  enctype="multipart/form-data">
			...
			{ 
				?>
				<p>
					<label class="title pc-t5"><?php __('front_label_rate');?>:</label>
					<input type="hidden" id="rating_value" name="rating" value="" />
					<span class="rating">
						<span id="star_1" class="pc-star pc-t7 pc-l10" lang="1"></span>
						<span id="star_2" class="pc-star pc-t7" lang="2"></span>
						<span id="star_3" class="pc-star pc-t7" lang="3"></span>
						<span id="star_4" class="pc-star pc-t7" lang="4"></span>
						<span id="star_5" class="pc-star pc-t7" lang="5"></span>
					</span>
				</p>
				<?php
			} 
			...
			<p>
				...
				<button type="submit" class="submitRequestButton pc-button" onclick="PC.Utils.postComment(event, 'frmPostComment', 'pc-message-container', this); return false;"><?php __('front_button_add_comment');?></button>
			</p>
		</form>
	</div>
</div>