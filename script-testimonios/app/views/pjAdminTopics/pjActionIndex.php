...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoPagesTitle', true), __('infoPagesDesc', true)); 
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminTopics" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="<?php __('btnAddPage'); ?>" />
		</form>
	...
	myLabel.comments = "<?php __('menuComments'); ?>";
	myLabel.page = "<?php __('lblPage'); ?>";
	myLabel.exportcomments = "<?php __('lblExportComments'); ?>";
	myLabel.install = "<?php __('lnkInstall'); ?>";
	myLabel.preview = "<?php __('lblPreview'); ?>";
	myLabel.active = "<?php __('pc_active'); ?>";
	myLabel.inactive = "<?php __('pc_inactive'); ?>";
