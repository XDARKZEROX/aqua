...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('member_list_titles_title', true), __('member_list_titles_body', true)); 
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminMembers" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="<?php __('btnAddCommenter'); ?>" />
		</form>
	...
	myLabel.membersince = "<?php __('lblMemberSince'); ?>";
